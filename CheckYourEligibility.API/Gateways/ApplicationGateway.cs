...
{
    public partial class ApplicationGateway : BaseGateway, IApplication
    {
        ...
        public ApplicationGateway(ILoggerFactory logger, IEligibilityCheckContext dbContext, IMapper mapper, IConfiguration configuration) : base()
        {
        ...
        public async Task<ApplicationResponse> PostApplication(ApplicationRequestData data)
        {
            try
            {
                ...
                {
                    item.Status = API.Domain.Enums.ApplicationStatus.Entitled;
                }
                else
                {
                    item.Status = API.Domain.Enums.ApplicationStatus.EvidenceNeeded;
                }
                ...
                await AddStatusHistory(item, API.Domain.Enums.ApplicationStatus.Entitled);
        ...
        private async Task AddStatusHistory(Application application, API.Domain.Enums.ApplicationStatus applicationStatus)
        {
