...
namespace CheckYourEligibility.API.Tests.UseCases
{
    ...
    public class GetBulkUploadResultsUseCaseTests : TestBase.TestBase
    {
        ...
        public async Task Execute_returns_notFound_when_gateway_returns_null()
        {
            ...
            _mockCheckGateway.Setup(s => s.GetBulkCheckResults<IList<CheckEligibilityItem>>(guid)).ReturnsAsync((IList<CheckEligibilityItem>)null);
        ...
        public async Task Execute_returns_success_with_correct_data_when_gateway_returns_results()
        {
            ...
            _mockCheckGateway.Setup(s => s.GetBulkCheckResults<IList<CheckEligibilityItem>>(guid)).ReturnsAsync(resultItems);
            _mockAuditGateway.Setup(a => a.CreateAuditEntry(AuditType.CheckBulkResults, guid)).ReturnsAsync(_fixture.Create<string>());
