...
namespace CheckYourEligibility.API.Tests.UseCases
{
    ...
    public class CheckEligibilityBulkUseCaseTests : TestBase.TestBase
    {
        ...
        public async Task Execute_calls_gateways_with_correct_parameters_when_valid()
        {
            ...
            _mockCheckGateway.Setup(s => s.PostCheck(It.IsAny<IEnumerable<CheckEligibilityRequestData_Fsm>>(), It.IsAny<string>()))
            ...
            _mockCheckGateway.Verify(s => s.PostCheck(It.IsAny<IEnumerable<CheckEligibilityRequestData_Fsm>>(), It.IsAny<string>()), Times.Once);
        ...
        public async Task Execute_returns_failure_when_model_type_is_not_expected()
        {
            ...
            _mockCheckGateway.Verify(s => s.PostCheck(It.IsAny<IEnumerable<CheckEligibilityRequestData_Fsm>>(), It.IsAny<string>()), Times.Never);
