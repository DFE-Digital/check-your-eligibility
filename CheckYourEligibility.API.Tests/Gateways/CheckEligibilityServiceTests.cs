...
namespace CheckYourEligibility.API.Tests
{
    ...
    public class CheckEligibilityServiceTests : TestBase.TestBase
    {
        ...
        public void Setup()
        {
            ...
            _sut = new CheckEligibilityGateway(new NullLoggerFactory(), _fakeInMemoryDb, _mapper, new QueueServiceClient(webJobsConnection),
        ...
        public async Task Given_PostCheck_ExceptionRaised()
        {
            ...
            var svc = new CheckEligibilityGateway(new NullLoggerFactory(), db.Object, _mapper, null, _configuration, _moqDwpGateway.Object, _moqAudit.Object, _hashGateway);
        ...
        public async Task Given_PostCheck_HashIsOldSoNewOne_generated()
        {
            ...
            _moqDwpGateway.Setup(x => x.GetCitizen(It.IsAny<CitizenMatchRequest>())).ReturnsAsync(Guid.NewGuid().ToString());
        ...
        public async Task Given_validRequest_Process_Should_Return_updatedStatus_parentNotFound()
        {
            ...
            _moqDwpGateway.Setup(x => x.GetCitizen(It.IsAny<CitizenMatchRequest>())).ReturnsAsync(CheckEligibilityStatus.parentNotFound.ToString());
            _moqAudit.Setup(x => x.AuditAdd(It.IsAny<AuditData>())).ReturnsAsync("");
